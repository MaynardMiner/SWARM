...
if ($Name -in $(arg).PoolName) {
    ...
    $Pool_Sorted | ForEach-Object {
        $Raw = shuffle $_.estimate_last24h $_.actual_last24h_shared
    ...
    $Pool_Sorted | ForEach-Object {
        ...
        $Stat = Global:Set-Stat -Name $StatPath -HashRate $HashRate -Value ( $Estimate / $Divisor * (1 - ($_.fees / 100))) -Shuffle $([double]$_.deviation)
