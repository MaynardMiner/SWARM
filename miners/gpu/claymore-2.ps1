...
if($CoinAlgo -eq $null)
{
  ...
  Devices = $Devices
  DeviceCall = "claymore"
  Arguments = "-platform 2 -mport 2333 -mode 1 -allcoins 1 -allpools 1 -epool $($_.Protocol)://$($_.Host):$($_.Port) -ewal $($_.User2) $MinerWorker-wd 0 -gser 2 -dbg -1 -eres 1 $($Config.$ConfigType.commands.$($_.Algorithm))"
