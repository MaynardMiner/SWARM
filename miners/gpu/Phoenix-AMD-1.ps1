...
if($CoinAlgo -eq $null)
{
  ...
  Devices = $Devices
  DeviceCall = "claymore"
  Arguments = "-platform 1 -mport 8333 -mode 1 -allcoins 1 -allpools 1 -epool $($_.Protocol)://$($_.Host):$($_.Port) -ewal $($_.User1) -epsw $($_.Pass1)$($Diff) -wd 0 -dbg -1 -eres 2 $($Config.$ConfigType.commands.$($_.Algorithm))"
