...
if($CoinAlgo -eq $null)
 ...
 $Commands | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name | ForEach-Object {
  if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
   ...
   Devices = $Devices
   DeviceCall = "claymore"
   Arguments = "-mport 3334 -mode 1 -allcoins 1 -allpools 1 -epool $($AlgoPools.$_.Protocol)://$($AlgoPools.$_.Host):$($AlgoPools.$_.Port) -ewal $($AlgoPools.$_.User2) -epsw $($AlgoPools.$_.Pass2)($Diff) -wd 0 -dbg -1 -eres 1 $($Commands.$_)"
...
$CoinPools | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name |
  ...
  Devices = $Devices
  DeviceCall = "claymore"
  Arguments = "-mport 3334 -mode 1 -allcoins 1 -allpools 1 -epool $($CoinPools.$_.Protocol)://$($CoinPools.$_.Host):$($CoinPools.$_.Port) -ewal $($CoinPools.$_.User2) -epsw $($CoinPools.$_.Pass2)$($Diff) -wd 0 -dbg -1 -eres 1 $($Commands.$($CoinPools.$_.Algorithm))"
