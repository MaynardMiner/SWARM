  ...
  if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
   {
    ...
    Devices = $Devices
    DeviceCall = "claymore"
    Arguments = "-mport 3335 -mode 1 -allcoins 1 -allpools 1 -epool $($AlgoPools.$_.Protocol)://$($AlgoPools.$_.Host):$($AlgoPools.$_.Port) -ewal $($AlgoPools.$_.User3) -epsw $($AlgoPools.$_.Pass3)$($Diff) -wd 0 -dbg -1 -eres 1 $($Commands.$_)"
...
$CoinPools | Get-Member -MemberType NoteProperty | Select-Object -ExpandProperty Name |
 ...
 Devices = $Devices
 DeviceCall = "claymore"
 Arguments = "-mport 3335 -mode 1 -allcoins 1 -allpools 1 -epool $($CoinPools.$_.Protocol)://$($CoinPools.$_.Host):$($CoinPools.$_.Port) -ewal $($CoinPools.$_.User3) -epsw $($CoinPools.$_.Pass3)$($Diff) -wd 0 -dbg -1 -eres 1 $($Commands.$($CoinPools.$_.Algorithm))"
 HashRates = [PSCustomObject]@{$_ = $($Stats."$($Name)_$($_)_hashrate".Day)}
