...
if($CoinAlgo -eq $null)
 ...
 if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
  ...
  Devices = $Devices
  DeviceCall = "ccminer"
  Arguments = "-a $(Get-Nvidia($_)) -o  $($AlgoPools.$_.Protocol)://$($AlgoPools.$_.Host):$($AlgoPools.$_.Port) -b 0.0.0.0:4069 -u $($AlgoPools.$_.User2) -p $($AlgoPools.$_.Pass2)$($Diff) $($Commands.$_)"
