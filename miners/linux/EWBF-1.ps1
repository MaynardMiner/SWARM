...
if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
 ...
 if($Config.$ConfigType.difficulty.$_){$Diff=",d=$($Difficulty.$_)"}
      ...
      Devices = $Devices
      DeviceCall = "ewbf"
      Arguments = "--api 0.0.0.0:42000 --server $($AlgoPools.$_.Host) --port $($AlgoPools.$_.Port) --user $($AlgoPools.$_.User1) --pass $($AlgoPools.$_.Pass1)$($Diff) $($Config.$ConfigType.commands.$_)"
  ...
  Devices = $Devices
  DeviceCall = "ewbf"
  Arguments = "--api 0.0.0.0:42000 --server $($CoinPools.$_.Host) --port $($CoinPools.$_.Port) --user $($CoinPools.$_.User1) --pass $($CoinPools.$_.Pass1)$($Diff) $($Config.$ConfigType.commands.$($Coinpools.$_.Algorithm))"
