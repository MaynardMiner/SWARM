...
if($CoinAlgo -eq $null)
{
  ...
  [PSCustomObject]@{
      ...
      Devices = $Devices
      DeviceCall = "trex"
      Arguments = "-a $($Config.$ConfigType.naming.$($_.Algorithm)) -o stratum+tcp://$($_.Host):$($_.Port) --api-bind-telnet 0.0.0.0:4070 --api-bind-http 0.0.0.0:4073 -u $($_.User1) -p $($_.Pass1)$($Diff) $($Config.$ConfigType.commands.$($_.Algorithm))"
