...
if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
 ...
 if($Config.$ConfigType.difficulty.$_){$Diff=",d=$($Difficulty.$_)"}
      ...
      Devices = $Devices
      DeviceCall = "ewbf"
      Arguments = "--api 0.0.0.0:42002 --server $($AlgoPools.$_.Host) --port $($AlgoPools.$_.Port) --user $($AlgoPools.$_.User3) --pass $($AlgoPools.$_.Pass3)$($Diff) $($Config.$ConfigType.commands.$_)"
  ...
  Devices = $Devices
  DeviceCall = "ewbf"
  Arguments = "--api 0.0.0.0:42002 --server $($CoinPools.$_.Host) --port $($CoinPools.$_.Port) --user $($CoinPools.$_.User3) --pass $($CoinPools.$_.Pass3)$($Diff) $($Config.$ConfigType.commands.$($Coinpools.$_.Algorithm))"
