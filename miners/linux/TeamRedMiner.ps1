...
if($CoinAlgo -eq $null)
{
  ...
  if($Algorithm -eq "$($AlgoPools.$_.Algorithm)")
  {
    ...
    Devices = $Devices
    DeviceCall = "tdxminer"
    Arguments = "--platform $AMDPlatform -a $($Config.$ConfigType.naming.$_) --api_listen=0.0.0.0:4028 -o stratum+tcp://$($AlgoPools.$_.Host):$($AlgoPools.$_.Port) -u $($AlgoPools.$_.User1) -p $($AlgoPools.$_.Pass1)$($DIff) $($Config.$ConfigType.commands.$_)"
  ...
  foreach {
   ...
   Devices = $Devices
   DeviceCall = "tdxminer"
   Arguments = "--platform $AMDPlatform -a $($Config.$ConfigType.naming.$($CoinPools.$_.Algorithm)) -o stratum+tcp://$($CoinPools.$_.Host):$($CoinPools.$_.Port) -u $($CoinPools.$_.User1) -p $($CoinPools.$_.Pass1)$($Diff) $($Config.$ConfigType.commands.$($CoinPools.$_.Algorithm))"
