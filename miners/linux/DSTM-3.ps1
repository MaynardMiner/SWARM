...
FullName = "$($AlgoPools.$_.Mining)"
 ...
 Devices = $Devices
 DeviceCall = "dstm"
 Arguments = "--server $($CoinPools.$_.Host) --port $($CoinPools.$_.Port) --user $($CoinPools.$_.User3) --pass $($CoinPools.$_.Pass3)$($Diff) --telemetry=0.0.0.0:43001 $($Config.$ConfigType.commands.$($Coinpools.$_.Algorithm))"
