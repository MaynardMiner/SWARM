$AMDTypes | ForEach-Object {
    ...
    $User = "User$Num"; $Pass = "Pass$Num"; $Name = "xmrig-$Num"; $Port = "3300$Num"
        ...
        $Pools | Where-Object Algorithm -eq $MinerAlgo | ForEach-Object {
            if ($Algorithm -eq "$($_.Algorithm)" -and $Bad_Miners.$($_.Algorithm) -notcontains $Name) {
                ...
                [PSCustomObject]@{
                    ...
                    DeviceCall = "gminer"
                    Arguments  = "--api $Port --server $($_.Host) --port $($_.Port) --user $($_.$User) --pass $($_.$Pass)$Diff $($Config.$ConfigType.commands.$($_.Algorithm))"
