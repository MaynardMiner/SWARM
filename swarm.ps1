...
if ($PSVersionTable.PSVersion -ne "7.0.1") {
    Write-Host "WARNING: Powershell Core Version is $($PSVersionTable.PSVersion)" -ForegroundColor Red
    Write-Host "Currently supported version for SWARM is 7.0.1" -ForegroundColor Red
    ...
    Write-Host "https://github.com/PowerShell/PowerShell/releases/tag/v7.0.1" -ForegroundColor Red
    Write-Host ""
