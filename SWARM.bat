...
pwsh -executionpolicy Bypass -command ".\startup-win.ps1 -Auto_Coin Yes -RigName1 SWARM1 -Currency USD -CoinExchange LTC -Location US -PoolName hashrefinery,zergpool,fairpool,nicehash,nlpool,blockmasters,phiphipool,zpool,blazepool,ahashpool -Type CPU -CPUThreads 2 -Wallet1 1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i -Donate .5 -WattOMeter Yes -Farm_Hash xxxxxxxxxxxxxxxxxxxxxxxxxxxx"