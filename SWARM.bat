...
pwsh -executionpolicy Bypass -command ".\startup.ps1 -Auto_Coin Yes -RigName1 SWARM1 -Currency USD -CoinExchange LTC -Location US -PoolName hashrefinery,zergpool,fairpool,nicehash,nlpool,blockmasters,phiphipool,zpool,blazepool,ahashpool -Type NVIDIA2,AMD1 -CPUThreads 2 -Wallet1 1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i -Donate .5 -WattOMeter Yes -Farm_Hash ab1172091a9de3006185116f29aa32a7814796b7"