    ...
    $Pool_Data = $Algos | ForEach-Object -Parallel {
        ...
        $To_Add | ForEach-Object { 
            ...
            [Pool]::New(
                ...
                $User3,
                ## Pass1
                "c=$Pass1,$($mc)ID=$($Params.RigName1),ref=25be7e349d2cfd7a5cd9fd7883fd08f2",
                ## Pass2
                "c=$Pass2,$($mc)ID=$($Params.RigName2),ref=25be7e349d2cfd7a5cd9fd7883fd08f2",
                ## Pass3
                "c=$Pass3,$($mc)ID=$($Params.RigName3),ref=25be7e349d2cfd7a5cd9fd7883fd08f2",
                ## Previous
                $previous
            )
        }
