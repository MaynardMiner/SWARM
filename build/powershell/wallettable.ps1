...
$Formatted_Table += "         Unpaid = $($_.Unpaid)"
$Formatted_Table += "         Balance = $($_.Balance)"
$Formatted_Table += "         Last Checked = $($_.Last_Checked)"
}
$Formatted_Table += " "
$Formatted_Table += "Total Unpaid = $($_.Total_Unpaid)"
$Formatted_Table += "Total Balance = $($_.Total_Balance)"
$Formatted_Table += "Total Estimated = $($_.Total_Estimated)"
