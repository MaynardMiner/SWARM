...
" -foregroundcolor green
                ...
                if ($Global:Strike -ne $true) {
                    ## It benchmarked. Reset the Warnings.
                    ...
                    if ($Global:Strike -eq $true) {
                        if ($global:WasBenchmarked -eq $False) {
                            ...
                            if (-not $MinerPoolBan -and -not $MinerAlgoBan -and -not $MinerBan ) {
                                log "First Strike: There was issue with benchmarking. `n" -ForegroundColor DarkRed;
                            }
                            ...
                            if ($MinerPoolBan -eq $true) {
                                ...
                                log "Strike Two: Benchmarking Has Failed - $HiveMessage `n" -ForegroundColor DarkRed
                            ...
                            if ($MinerAlgoBan -eq $true) {
                                ...
                                log "Strike three: $HiveMessage `n" -ForegroundColor DarkRed
                                Global:Get-HiveWarning $HiveMessage
                                $NewAlgoBlock = @()
